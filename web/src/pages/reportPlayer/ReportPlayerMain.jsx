...
export default function ReportPlayerMain({postData, sendToDiscord, cooldown, setCoolDown}) {
    ...
    function send() {
        ...
        sendToDiscord(postData.player.report, playerName, comment, 'Report On Player', postData.player.tag)
    ...
    return (
        ...
        <label htmlFor="reportedPlayer" >Players Name or Id</label>
        <input id="reportedPlayer" type="text" value={playerName} onChange={(e) => changePlayerName(e)} placeholder="Players Name" />
